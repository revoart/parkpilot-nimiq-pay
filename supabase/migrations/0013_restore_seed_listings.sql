-- ParkPilot: restore the demo catalogue.
-- Listings 101, 102, 106, 107 and 108 were deleted during host-UI testing
-- (delete-parking-space also removes their photo objects), leaving only four
-- listings. This re-seeds the full Toronto set; `on conflict do nothing` makes
-- it safe to re-run and harmless for listings that still exist.
--
-- Photos are restored separately (they live in Storage), see README.
